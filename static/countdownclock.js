(function() {
    var animation = {
      ...
      get period() {
        var dateFuture = new Date(2024, 0, 6, 19);
      ...
      render: function() {
        animation.controls.seconds.innerHTML = animation.plural("segundos");
        animation.controls.minutes.innerHTML = animation.plural("minutos");
        animation.controls.hours.innerHTML = animation.plural("horas");
        animation.controls.days.innerHTML = animation.plural("dias");
